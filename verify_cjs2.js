...
const outFile = path.join(__dirname, 'db_report2.txt');
const prisma = new PrismaClient({
  datasources: { db: { url: 'postgresql://neondb_owner:npg_9EkJbGQ1sKZD@ep-curly-tree-az1g44up.c-3.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&connect_timeout=60&pool_timeout=60' } }
});
