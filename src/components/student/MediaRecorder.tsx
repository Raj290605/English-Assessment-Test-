    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between p-3 rounded-xl bg-slate-900 border border-slate-800">
        <div className="flex items-center gap-2">
          ...
          {status === 'UPLOADING' && (
            <span className="text-blue-400 font-bold text-xs uppercase tracking-wider flex items-center gap-1.5">
        ...
        {/* Timer */}
        <div className="font-mono text-sm font-bold text-slate-200 px-3 py-1 rounded bg-slate-800 border border-slate-700">
        ...
        {(status === 'STOPPED' || status === 'SAVED') && (
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <button
              ...
              className="py-2.5 px-4 bg-slate-800 hover:bg-slate-700 text-slate-200 font-semibold rounded-xl border border-slate-700 flex items-center gap-2 text-xs transition-colors"
            >
