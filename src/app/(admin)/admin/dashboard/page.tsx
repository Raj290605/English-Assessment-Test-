        ...
        <div className="glass-panel p-8 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="p-4 rounded-xl bg-slate-900/90 border border-slate-800 text-center">
                <span className="text-xs text-slate-400 block font-medium">Submissions Ready</span>
                    ...
                    <tr key={s.id} className="hover:bg-slate-800/40 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        {s.evaluation?.overallScore ? (
                          <span className="px-3 py-1 rounded-lg bg-emerald-500/10 text-emerald-400 font-mono font-extrabold text-sm border border-emerald-500/20">
                      ...
                      <td className="px-6 py-4 text-right">
                        <Link
                          ...
                          className="inline-flex items-center gap-1.5 py-2 px-4 bg-slate-800 hover:bg-emerald-600 hover:text-white text-emerald-400 font-semibold rounded-xl border border-slate-700 hover:border-emerald-500 text-xs transition-all"
                        >
                          Review & Grade
