      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 py-6 space-y-6">
        ...
        <div className="glass-panel p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            ...
            <h2 className="text-lg font-bold text-white">
              Progress: <span className="text-blue-400 font-mono">{totalAnswered}</span> / 25 Answered
            </h2>
          </div>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-slate-800">
          <button
            ...
            className="py-2.5 px-5 bg-slate-800 hover:bg-slate-700 text-slate-300 font-semibold rounded-xl border border-slate-700 flex items-center gap-2 text-sm disabled:opacity-40 transition-colors"
          >
          ...
          <div className="glass-panel max-w-md w-full p-6 space-y-4 relative">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-slate-800">
              <button
                ...
                className="py-2 px-4 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-lg text-sm font-semibold transition-colors"
              >
                Review Responses
              </button>
              <button
