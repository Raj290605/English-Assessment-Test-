    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-xl w-full text-center space-y-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
          ...
          >
            <div className="w-12 h-12 rounded-xl bg-blue-500/10 text-blue-400 flex items-center justify-center mb-3 group-hover:bg-blue-500 group-hover:text-white transition-colors">
              <User className="w-6 h-6" />
            </div>
            <h2 className="text-xl font-bold text-white">Student Portal</h2>
            <p className="text-xs text-slate-400 mt-1">Take speaking assessment</p>
          </Link>
          ...
          >
            <div className="w-12 h-12 rounded-xl bg-emerald-500/10 text-emerald-400 flex items-center justify-center mb-3 group-hover:bg-emerald-500 group-hover:text-white transition-colors">
              <ShieldCheck className="w-6 h-6" />
            </div>
            <h2 className="text-xl font-bold text-white">Admin Portal</h2>
            <p className="text-xs text-slate-400 mt-1">Review & grade assessments</p>
          </Link>
        </div>
